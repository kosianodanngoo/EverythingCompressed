...
public class EverythingCompressedConfig {
    ...
    public static final ForgeConfigSpec.LongValue EXTRACTION_TIME = BUILDER.comment("Ticks required for singularity extraction").defineInRange("extractionTime", 60, 1, Long.MAX_VALUE);
