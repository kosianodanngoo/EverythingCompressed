...
public class SingularityExtractorMenu extends AbstractContainerMenu {
    ...
    public final SingularityExtractorBlockEntity blockEntity;
    ...
    public SingularityExtractorMenu(int pContainerId, Inventory inventory, SingularityExtractorBlockEntity blockEntity, ContainerData data) {
        super(ModMenuTypes.SINGULARITY_EXTRACTOR.get(), pContainerId);
        this.player = inventory.player;
        this.blockEntity = blockEntity;
        this.data = data;

        addSlot(new SlotItemHandler(blockEntity.getInventory(), 0, 44, 47));
        addSlot(new SlotItemHandler(blockEntity.slotOutputHandler, 0, 116, 47));
